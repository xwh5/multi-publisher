...
- 移除 12 个未实装壳适配器：百家号、博客园、豆瓣、东方财富、慕课网、开源中国、思否、搜狐号、人人都是产品经理、雪球、语雀、51CTO（含注册表/登录/配置/Cookie 管理全部清理）

### Changed

- 平台清单收敛为 9 个：微信、头条号（已实测）＋知乎、掘金、CSDN、小红书、企鹅号、微博、B站（适配器就绪，待实测）
- README/SPEC 如实化：删除「20+ 平台」「无浏览器依赖」等过时承诺；新增平台可用性表
